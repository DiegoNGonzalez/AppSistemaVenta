...
export class VentaService {
  ...
  historial(buscarPor:string,numeroVenta:string,fechaInicio:string, fechaFin:string){
  ...
  reporte(fechaInicio:string, fechaFin:string){
    return this.http.get(`${this.urlApi}Reporte?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`);
